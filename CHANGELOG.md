...
- **dispatch:** Stabilize account handling for credits, backoff, and codex(0982e87)
- **qoder:** Correct quota message for trials and team plans(b144619)
- **stability:** Harden review findings on PAT exchange, dedup, and classification(07b4127)
- Grok-cli proxy headers, effort model aliases, and foreign import body limit(80dda25)


### Documentation

- Update CHANGELOG.md and VERSION for v0.1.27(3f9b95f)


### Features

- **qoder:** Add Personal Access Token (PAT) support for authentication(997cb6d)
